...
users.forEach(({ email, password, profile, roles }) => {
  ...
  if (!userExists) {
    ...
    const default_communities = [
      ...
      { name:"SMU", description: "Singapore Management University", ownerId: userId, count:1, pictureId: "smulogo_xfitp3", website: "http://smu.edu.sg", coordinates: [1.2967458,103.8507972], zoom: 18, mapURL: "https://api.mapbox.com/styles/v1/leonmak/ciqri96i70002cbnhztwxix8a/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoibGVvbm1hayIsImEiOiJkNzQ3YWVlZDczYjMxNjhhMjVhZWI4OWFkM2I2MWUwOCJ9.uL_x_vTDIse10HSvMb6XIg"},
    ];
