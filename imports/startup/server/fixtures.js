...
const default_communities = [
  ...
  { name:"NTU", feature: true, description: "Nanyang Technological University of Singapore", ownerId: adminUserId, count:1, pictureId: "school-logos/ntu-logo", website: "http://ntu.edu.sg", coordinates: [1.3484298,103.688698], zoom: 16, mapURL: "https://api.mapbox.com/styles/v1/leonmak/cilzxkl5400hrcglvjxu6qxpz/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoibGVvbm1hayIsImEiOiJkNzQ3YWVlZDczYjMxNjhhMjVhZWI4OWFkM2I2MWUwOCJ9.uL_x_vTDIse10HSvMb6XIg"},
  { name:"SMU", feature: true, description: "Singapore Management University", ownerId: adminUserId, count:1, pictureId: "school-logos/smu-logo", website: "http://smu.edu.sg", coordinates: [1.2966231,103.8508909], zoom: 18, mapURL: "https://api.mapbox.com/styles/v1/leonmak/ciqri96i70002cbnhztwxix8a/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoibGVvbm1hayIsImEiOiJkNzQ3YWVlZDczYjMxNjhhMjVhZWI4OWFkM2I2MWUwOCJ9.uL_x_vTDIse10HSvMb6XIg"},
  { name:"SUTD", feature: true, description: "Singapore University of Technology & Design", ownerId: adminUserId, count:1, pictureId: "school-logos/sutd-logo", website: "http://sutd.edu.sg", coordinates: [1.3414995,103.9643371], zoom: 18, mapURL: "https://api.mapbox.com/styles/v1/leonmak/ciqri96i70002cbnhztwxix8a/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoibGVvbm1hayIsImEiOiJkNzQ3YWVlZDczYjMxNjhhMjVhZWI4OWFkM2I2MWUwOCJ9.uL_x_vTDIse10HSvMb6XIg"},
];
